...
3.  **migration** (алиас `mig`):
    ...
    * `age` (STRING): (Используй `mig.age`). Все уникальные значения столбца mig.age: ['0-4', '10-14', '100', '15-19', '20-24', '25-29', '3-5', '30-34', '35-39', '40-44', '45-49', '5-9', '50-54', '55-59', '60-64', '65-69', '70-74', '75-79', '80-84', '85-89', '90-94', '95-99', 'Всего']
